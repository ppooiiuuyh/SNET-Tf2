...
class Model_Train():
    ...
    def build_model(self):
        ...
        self.learning_rate =  tf.maximum(0.000001,tf.cast(tf.compat.v1.train.exponential_decay(self.config.learning_rate, self.step, 10000, 0.1,  staircase=True,   name=None),dtype=tf.float32))
